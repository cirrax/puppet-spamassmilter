...
describe 'spamassmilter::config' do
  ...
  shared_examples_for 'spamassmilter::config' do
    ...
    it {
      is_expected.to contain_file_line('spamassmilter: options')
        .with_ensure('present')
    ...
    it {
      is_expected.to contain_file_line('spamassmilter: socket')
        .with_path(params[:sysconfig_file])
        .with_match('^SOCKET=')
        .with_notify('Service[spamass-milter]')
    }
    ...
    it {
      is_expected.to contain_file_line('spamassmilter: socketowner')
        .with_path(params[:sysconfig_file])
    ...
    it {
      is_expected.to contain_file_line('spamassmilter: socketmode')
        .with_path(params[:sysconfig_file])
